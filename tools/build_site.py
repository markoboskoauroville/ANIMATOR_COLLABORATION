...
<p>THE BRAIN BRAKE</p><input id=pw autofocus autocomplete=off><p id=ge></p></form></div>
<script>
function g(e){e.preventDefault();var v=document.getElementById('pw').value.trim().toLowerCase();
if(v==='PASSPHRASE'){document.cookie='bbc=1;max-age=7776000;path=/';o();}
else{document.getElementById('ge').textContent='NO';}}
function o(){document.getElementById('gate').style.display='none';
document.getElementById('app').style.display='block';}
if(document.cookie.indexOf('bbc=1')>-1){window.addEventListener('DOMContentLoaded',o);}
